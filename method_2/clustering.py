...
def clustering(vertical):
	...
	print "Clustering "+str(vertical)+" with Method-2."
	
	if os.path.exists("../../data/"+str(vertical)+"/results/method_2/"):
		os.system("rm -r ../../data/"+str(vertical)+"/results/method_2/")
	os.system("mkdir ../../data/"+str(vertical)+"/results/method_2/")
	
	os.system("mkdir ../../data/"+str(vertical)+"/results/method_2/fastgreedy/")
	
	os.system("mkdir ../../data/"+str(vertical)+"/results/method_2/infomap/")
	
	os.system("mkdir ../../data/"+str(vertical)+"/results/method_2/walktrap/")
	
	os.system("mkdir ../../data/"+str(vertical)+"/results/method_2/fastgreedy/sales/")
	
	os.system("mkdir ../../data/"+str(vertical)+"/results/method_2/infomap/sales/")
	
	os.system("mkdir ../../data/"+str(vertical)+"/results/method_2/walktrap/sales/")
	
	os.system("mkdir ../../data/"+str(vertical)+"/results/method_2/fastgreedy/returns/")
	
	os.system("mkdir ../../data/"+str(vertical)+"/results/method_2/infomap/returns/")
	
	os.system("mkdir ../../data/"+str(vertical)+"/results/method_2/walktrap/returns/")
...
def evaluation(vertical,flag):
	...
	print "Training of "+str(vertical)+" "+str(method)+" begins."
	...
	with open("../../data/"+str(vertical)+"/results/method_2/"+str(method)+"/sales/clusters.txt","r") as f:
		content = f.readlines()
	...
	with open("../../data/"+str(vertical)+"/results/method_2/"+str(method)+"/returns/clusters.txt","r") as f:
		content = f.readlines()
		for lines in content:
	...
	if os.path.exists("../../data/"+str(vertical)+"/results/method_2/"+str(method)+"/sales_model.pickle"):
		os.remove("../../data/"+str(vertical)+"/results/method_2/"+str(method)+"/sales_model.pickle")
	with open("../../data/"+str(vertical)+"/results/method_2/"+str(method)+"/sales_model.pickle",'w') as f:
	...
	if os.path.exists("../../data/"+str(vertical)+"/results/method_2/"+str(method)+"/returns_model.pickle"):
		os.remove("../../data/"+str(vertical)+"/results/method_2/"+str(method)+"/returns_model.pickle")
	with open("../../data/"+str(vertical)+"/results/method_2/"+str(method)+"/returns_model.pickle",'w') as f:
	...
	if os.path.exists("../../data/"+str(vertical)+"/results/method_2/"+str(method)+"/combo_model.pickle"):
		os.remove("../../data/"+str(vertical)+"/results/method_2/"+str(method)+"/combo_model.pickle")
	with open("../../data/"+str(vertical)+"/results/method_2/"+str(method)+"/combo_model.pickle",'w') as f:
	...
	if os.path.exists("../../data/"+str(vertical)+"/results/method_2/"+str(method)+"/eval.txt"):
		os.remove("../../data/"+str(vertical)+"/results/method_2/"+str(method)+"/eval.txt")
	eval_file = open("../../data/"+str(vertical)+"/results/method_2/"+str(method)+"/eval.txt","w")
