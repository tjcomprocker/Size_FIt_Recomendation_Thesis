...
for both in ["sales","returns"]:
	...
	fl = open("../../data/"+str(vertical)+"/results/method_2/fastgreedy/"+str(both)+"/clusters.txt",'w')
	...
	fl = open("../../data/"+str(vertical)+"/results/method_2/walktrap/"+str(both)+"/clusters.txt",'w')
	...
	fl = open("../../data/"+str(vertical)+"/results/method_2/infomap/"+str(both)+"/clusters.txt",'w')
